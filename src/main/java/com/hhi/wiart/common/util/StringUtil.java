...
public class StringUtil {
	 ...
	 * 
	 * <PRE>
	 * 1. MethodName: getRandomStrInt
	 * 2. ClassName : StringUtil
	 * 3. Comment   : 20자리 영문+숫자 랜덤코드 만들기
	 * 4. 작성자    : twkim
	 * 5. 작성일    : 2018. 2. 26.
	 * </PRE>
	 *   @return String
	 *   @return
	 */
	public static String getRandomStrInt() {
	 ...
	 * @return
	 */
    public static String decodePkgNm(String pkgNm) throws Exception {
        LOGGER.debug("encode package name : " + pkgNm);
        if(pkgNm == null || "".equals(pkgNm)) {
            LOGGER.error("Error package name : " + pkgNm);
        }
        String decPkgNm = new String(new BASE64Decoder().decodeBuffer(pkgNm));
        LOGGER.debug("decode package name : " + decPkgNm);
        return decPkgNm;
    }
     ...
     * @return
     */
    public static String encodePkgNm(String pkgNm) throws Exception {
        LOGGER.debug("encodePakNm(package name) : " + pkgNm);
        if(pkgNm == null || "".equals(pkgNm)) {
            LOGGER.error("Error package name : " + pkgNm);
        }
        String encPkgNm = new BASE64Encoder().encode(pkgNm.getBytes());
        LOGGER.debug("encode package name : " + encPkgNm);
        return encPkgNm;
    }
     ...
     */
    final public static String getImplodeMapKey(String glue, Map<String,String> map)
    {
        boolean first = true;
        StringBuilder sb = new StringBuilder();
    ...
    final public static String getImplodeMapValue(String glue, Map<String,String> map)
    {
        boolean first = true;
        StringBuilder sb = new StringBuilder();
        for( String key : map.keySet() ){
